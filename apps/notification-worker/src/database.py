...
async def confirm_order(order_id: str, ticket_code: uuid.UUID, worker: str) -> bool:
    """Confirma o pedido e gera o código do ingresso. Retorna False se já confirmado (idempotência)."""
